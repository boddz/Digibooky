...
class MemberControllerTest {
    ...
    void addNewMember_memberIsAddedToRepository(){
        ...
        MemberDto actual = memberController.registerNewMember(new MemberRegistryDTO(83,"tom@gm.com","tom","dc","straat",5,9000,"Gent"));
        MemberDto expected = new MemberDto(new Member(83,"tom@gm.com","tom","dc","straat",5,9000,"Gent"));
